...
Saying the field to be `M`, `M` has to be a matrix where the column indices to time and data are assigned by function `fmt.colindex2data` (see [`fmt`](#fmt)) depending on the type of the data.
