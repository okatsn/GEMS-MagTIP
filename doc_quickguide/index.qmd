...
::: {.content-visible when-profile="zhtw"}
請同時參照 [GEMS-MagTIP 教程](/zh-TW/doc_tutorial/)
:::
...
<iframe width="1801" height="736" class="embedded-docs" src="/zh-TW/doc_tutorial/#環境" title="Environment and Dependencies"></iframe>
:::
...
::: {.content-visible when-profile="zhtw"}
### 標準格式資料
<iframe width="1801" height="736" src="/doc_tutorial/#標準格式數據" title=""></iframe>
:::
...
See also: [Tips on directory select and assignment.](/doc_library/#dirselect-tip)
:::
::::
